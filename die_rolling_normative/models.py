...
class Constants(BaseConstants):
    name_in_url = 'die_rolling_normative'
...
class Player(BasePlayer):
    q11 = models.IntegerField(initial=None, label="")
    q12 = models.IntegerField(initial=None, label="")
    q21 = models.IntegerField(initial=None, label="")
    q22 = models.IntegerField(initial=None, label="")
    q31 = models.IntegerField(initial=None, label="")
    q32 = models.IntegerField(initial=None, label="")
    q41 = models.IntegerField(initial=None, label="")
    q42 = models.IntegerField(initial=None, label="")
